        ...
        void Fly()
        {
            if (inAir)
            {
                ...
                if (isMovingForward)
                {
                    ...
                    flyingVehicleRigidbody.linearVelocity = targetVelocity;
                }
                else
                {
            ...
            {
                // Ground movement
                if (Mathf.Abs(flyingVehicleRigidbody.linearVelocity.y) < 0.1f)
                {
                    ...
                    flyingVehicleRigidbody.linearVelocity = new Vector3(targetVelocity.x, flyingVehicleRigidbody.linearVelocity.y, targetVelocity.z);
                }
                else
                {
                    currentSpeed = flyingVehicleRigidbody.linearVelocity.magnitude;
                }
            }
        }
    }
