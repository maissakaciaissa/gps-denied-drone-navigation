...
public class ThirdPersonCharacter : MonoBehaviour
{
    ...
    void CharacterMovementLogic()
    {
        ...
        if (arrowKeyDown)
        {
            ...
            characterRigidbody.linearVelocity = characterTransform.forward * characterMovementSpeed;
        }
        else
        {
            characterRigidbody.linearVelocity = new Vector3(0.0f, characterRigidbody.linearVelocity.y, 0.0f);
        }
    }
}