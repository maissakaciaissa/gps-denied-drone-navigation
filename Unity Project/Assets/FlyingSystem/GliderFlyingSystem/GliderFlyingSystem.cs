    ...
    public class GliderFlyingSystem : MonoBehaviour
    {
        ...
        void Fly()
        {
            if (inAir)
            {
                ...
                gliderRigidbody.linearVelocity = flyingVelocity;
                ...
                if (inAirflow)
                {
                    ...
                    gliderRigidbody.linearVelocity = flyingVelocity + Vector3.up * airflowSpeed;
                }
                else
                {
                    ...
                    if (airflowSpeed > 0.01f)
                    {
                        ...
                        gliderRigidbody.linearVelocity = flyingVelocity + new Vector3(0.0f, Mathf.Clamp(verticalSpeed - verticalAcceleration * Time.deltaTime, -99999999.0f, 0.0f), 0.0f) + Vector3.up * airflowSpeed;
                    }
                    else
                        gliderRigidbody.linearVelocity = flyingVelocity + new Vector3(0.0f, Mathf.Clamp(verticalSpeed - verticalAcceleration * Time.deltaTime, -99999999.0f, 0.0f), 0.0f);
                }
