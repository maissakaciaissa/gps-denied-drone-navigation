...
class SimulationEngine:
    ...
    def step(self, verbose: bool = False) -> Tuple[bool, str]:
        ...
        # Get the most likely condition for logging
        most_likely_condition = max(env_condition, key=env_condition.get) if env_condition else None
        condition_value = most_likely_condition.value if hasattr(most_likely_condition, 'value') else str(most_likely_condition)
